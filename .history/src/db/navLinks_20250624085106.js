...
export const navigationCompanyDashboard = [
    ...
    { navName: "Dashboard", pathName: "/company-dashboard"},
...
export const asideNavigation = [
    { navName: "Companies", pathName: "/admin-dashboard", icon: ""},
    { navName: "Recruiters", pathName: "recruiters-table", icon: ""},
    { navName: "Candidates", pathName: "candidate-table", icon: ""},
    { navName: "Interviews", pathName: "interviews-table", icon: ""},
    { navName: "Payments", pathName: "payments-table", icon: ""},
    { navName: "Reports", pathName: "reports-table", icon: ""},
    { navName: "Admins", pathName: "admins-table", icon: ""},
]