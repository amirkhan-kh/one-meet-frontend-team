...
import { Control,  Payments, SystemLogs } from "./pages/admin";
  ...
  return (
    <Routes>
      ...
      <Route path="/admin-dashboard" element={ <AdminDashboard/>} >
        ...
        <Route path="candidate-table" element={ <Payments/>}/>
        <Route path="interviews-table" element={ <SystemLogs/>}/>
        <Route path="payments-table" element={ <Control/>}/> 
        <Route path="recruiters-table" element={ <Control/>}/> 
        <Route path="reports-table" element={ <Control/>}/> 
        <Route path="admins-table" element={ <Control/>}/> 
      </Route>
