    ...
    <div className="px-3 py-5 sm:p-6">
      <div className="flex flex-col gap-10">
        <div className="w-[70%]">
          ...
          <p className="text-[1px] mb-8">Monitor and analyze the overall interview activities conducted by your team. This summary provides valuable insights into recruitment performance and trends over time.</p>
        </div>
        <div>
