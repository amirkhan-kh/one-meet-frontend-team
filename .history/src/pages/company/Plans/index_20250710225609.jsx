  ...
  <h3 className="text-[18px] font-bold mb-5">All Methods</h3>
   ...
   <div className="my-6">
          ...
          <div className="flex flex-col sm:flex-row items-center w-full justify-between gap-4">
            ...
            <div className="shadow p-3 bg-white rounded-sm w-full sm:w-[50%] hover:bg-[rgb(250,250,250)] transition-colors duration-500 ease-in-out  border-l-[4px] border-[#2b43d4]">
