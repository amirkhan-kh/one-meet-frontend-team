...
export const RecruitersCompany = () => {
  ...
  return (
    <div className="recruiter-wrapper p-3">
      {renderTable(<> <MdCheckCircleOutline className="inline mr-1"/> Active Recruiters </>, approved, false)}
      {renderTable(<> <MdAccessTime className="inline mr-1"/> Pending Approval by Company </>, pendingByCompany, true)}
      {renderTable(<><MdOpenInBrowser className="inline mr-1"/> Join Requests from Recruiters </> , pendingByRecruiter, true)}
    </div>
  );
};
