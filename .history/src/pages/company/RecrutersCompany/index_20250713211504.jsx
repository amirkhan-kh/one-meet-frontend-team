...
export const RecruitersCompany = () => {
  ...
  return (
    <div className="recruiter-wrapper p-3 bg-amber-300">
      {renderTable(
        <> <MdCheckCircleOutline size={24} className="inline mr-[2px] text-green-400"/> Active Recruiters <CompanyCreateRecruiterModal/> </>,
        approved, false
      )}
      {renderTable(
