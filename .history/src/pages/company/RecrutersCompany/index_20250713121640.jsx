...
export const RecruitersCompany = () => {
  ...
  return (
    <div className="recruiter-wrapper p-3">
      {renderTable(
        <> <MdCheckCircleOutline className="inline mr-1 text-green-400 font-semibold"/> Active Recruiters </>,
        approved, false
      )}
      {renderTable(
        <> <MdAccessTime className="inline mr-1"/> Pending Approval by Company </>,
