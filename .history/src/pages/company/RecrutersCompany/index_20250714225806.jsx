...
export const RecruitersCompany = () => {
  ...
  return (
    <div className="recruiter-wrapper p-3 ">
      {renderTable(
        <> 
        <div className="flex justify-between items-center w-full"> <div> <MdCheckCircleOutline size={24} className="inline mr-[2px] text-green-400"/> Active Recruiters  </div>     <CompanyCreateRecruiterModal/></div>  </>,
        approved, false
      )}
      {renderTable(
