...
const [currentPageRecruiter, setCurrentPageRecruiter] = useState(1);
...
const renderTable = (title, data, showAccept, currentPage, setCurrentPage) => {
      ...
      <div className="recruiter-section shadow-sm border-l-[4px] border-[#2b43d4] ">
        ...
        {data.length === 0 ? (
          ...
          <>
            <Table>
              <TableHeader>
                <TableRow className={`text-black hover:bg-[#f4f5fd] focus:ring-0 bg-[#f4f5fd]`}>
              ...
              <TableBody>
                {currentItems.map((r) => (
                  <React.Fragment key={r.id}>
                    <TableRow
                      className={`translate-x-3 bg-white hover:bg-white ${
