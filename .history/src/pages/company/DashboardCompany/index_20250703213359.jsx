    ...
    <div className="px-3 py-5 sm:p-6">
      <div className="flex w-full  mb-14">
        <div className="w-[70%]">
          ...
          <p className="text-[15px] mb-2">Monitor company activity statistics: View key performance metrics such as employee productivity, project progress, and other essential statistics to track company performance.</p>
