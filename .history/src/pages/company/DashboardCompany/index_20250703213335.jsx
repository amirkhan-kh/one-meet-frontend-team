    ...
    <div className="px-3 py-5 sm:p-6">
      <div className="flex w-full  mb-14">
        <div className="w-[70%]">
          ...
          <p className="text-[15px] mb-2">Manage recruiter applications: You can easily accept, analyze, and manage applications submitted by recruiters, streamlining the recruitment process.</p>
