    ...
    <div className="px-3 py-5 sm:p-6">
      <div className="flex w-full  mb-14">
        <div className="w-[70%]">
          ...
          <p className="text-[15px] mb-2"><strong>Manage recruiter applications:</strong> You can easily accept, analyze, and manage applications submitted by recruiters, streamlining the recruitment process.</p>
          <p className="text-[15px] mb-2"><strong>Monitor company activity statistics:</strong> View key performance metrics such as employee productivity, project progress, and other essential statistics to track company performance.</p>
          <p className="text-[15px] mb-2"><strong>Track application statuses:</strong> Keep track of the progress of applications, check which stage they are at, and take necessary actions as needed.</p>
          <p className="text-[15px] mb-2"><strong>Advanced filtering options:</strong> Quickly sort and manage recruiter applications using filters tailored to your company’s specific needs and requirements.</p>
          <p className="text-[15px] mb-2"><strong>Data visualization:</strong> Company activity statistics are presented visually with graphs and charts, making it easier to interpret and make data-driven decisions.</p>
        </div>
