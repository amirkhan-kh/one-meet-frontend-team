    ...
    <div className="px-3 py-5 sm:p-6">
      <div className="flex w-full  mb-14 justify-between">
        <div className="w-[60%]">
          ...
          <p className="text-[15px] mb-3"><strong>Manage recruiter applications:</strong> You can easily accept, analyze, and manage applications submitted by recruiters, streamlining the recruitment process.</p>
          <p className="text-[15px] mb-3"><strong>Monitor company activity statistics:</strong> View key performance metrics such as employee productivity, project progress, and other essential statistics to track company performance.</p>
          <p className="text-[15px] mb-3"><strong>Track application statuses:</strong> Keep track of the progress of applications, check which stage they are at, and take necessary actions as needed.</p>
          <p className="text-[15px] mb-3"><strong>Advanced filtering options:</strong> Quickly sort and manage recruiter applications using filters tailored to your company’s specific needs and requirements.</p>
          <p className="text-[15px] mb-3"><strong>Data visualization:</strong> Company activity statistics are presented visually with graphs and charts, making it easier to interpret and make data-driven decisions.</p>
        </div>
        <div className="w-[30%] rounded-sm shadow-sm" >
          {logo ? (
                <img
                  src={logo}
                  alt={data?.firstName}
      ...
      <div className="flex flex-col sm:flex-row w-full gap-3">
        <div className="shadow px-3 py-4 bg-white rounded-md w-full sm:w-[40%]">
