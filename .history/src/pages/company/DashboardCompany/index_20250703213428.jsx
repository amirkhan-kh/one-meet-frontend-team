    ...
    <div className="px-3 py-5 sm:p-6">
      <div className="flex w-full  mb-14">
        <div className="w-[70%]">
          ...
          <p className="text-[15px] mb-2"><strong>Track application statuses: Keep track of the progress of applications, check which stage they are at, and take necessary actions as needed.</p>
