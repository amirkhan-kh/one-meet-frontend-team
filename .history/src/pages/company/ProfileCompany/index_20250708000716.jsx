...
export const ProfileCompany = () => {
  ...
  <li className="text-sm text-gray-700 flex flex-col sm:flex-row sm:items-center justify-between">
    <span className="font-medium">Company Name</span>
    <span className="text-gray-900">{company?.name || "Not provided"}</span>
  </li>
