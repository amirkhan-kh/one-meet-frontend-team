...
console.log(data?.lastName);
  ...
  return (
    <div className=" px-4 lg:px-40 py-8">
      <h3 className="text-[20] sm:text-2xl font-semibold mb-4">
      ...
      <div className="flex flex-col md:flex-row gap-2 sm:gap-5 w-full">
        ...
        <div className="flex flex-col sm:flex-row md:flex-col w-full md:w-[30%] gap-2 sm:gap-6 md:gap-0">
          ...
          <div className="shadow px-3 sm:px-6 py-3 sm:py-8 bg-white rounded-md  sm:mb-10 w-full">
            <h3 className="font-semibold text-[18px]">Current Profile</h3>
            <div className="shadow rounded-sm w-full h-full">
              <img src={data?.profilePicture} alt="" />
            </div>
            <ul>
              <li className="text-[15px] text-gray-600 my-2">Company Name </li>
              <span>{data?.firstName}</span>
              <li className="text-[15px] text-gray-600 my-2">Corporate Email</li>
              <span>{}</span>
              <li className="text-[15px] text-gray-600 my-2">Website</li>
            </ul>
          </div>
          ...
          <div className="shadow px-3 sm:px-6 py-3 sm:py-8 bg-white rounded-md mb-4 sm:mb-10 w-full flex flex-col justify-between gap-4">
            ...
            <Button
                className={`text-white bg-gradient-to-r from-[#3b45d6] to-[#611bd6] transition-colors duration-400 ease-in-out hover:text-[#d0cccc]`}
                variant="outline">
        ...
        <div className="shadow p-4 bg-white rounded-md  w-full md:w-[70%]">
          <div className="flex flex-col justify-between gap-10">
            ...
            <label className="font-semibold text-[14] flex flex-col gap-3">
              Company Name
              <Input
                className={`bg-gray-100 border border-gray-200 focus:outline-none focus:border-none text-gray-500`}
              />
            </label>
            <label className="font-semibold text-[14] flex flex-col gap-3">
              Corporate Email
