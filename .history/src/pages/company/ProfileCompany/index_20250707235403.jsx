        ...
        <div className="flex flex-col sm:flex-row md:flex-col w-full md:w-[30%] gap-2 sm:gap-6 md:gap-0">
          <div className="shadow px-3 sm:px-6 py-3 sm:py-8 bg-white rounded-md mb-4 sm:mb-10 w-full">
            ...
            <ul>
              ...
              <li className="text-[15px] text-gray-600 my-2">LinkedIn</li>
              <span><a href={company?.linkedin || "Noma'lum"}></a>{company?.linkedin}</span>
              <li className="text-[15px] text-gray-600 my-2">Website</li>
              <span><a href={company?.website || "Noma'lum"}>{company?.website || "Noma'lum"}</a></span>
            </ul>
          </div>
