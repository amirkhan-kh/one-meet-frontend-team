...
import { monthlyUsageList } from "@/db/static-list";
...
export const ReportsTable = () => {
   const itemsPerPage = 10;
    ...
    const totalPages = Math.ceil(monthlyUsageList.length / itemsPerPage);
    const startIdx = (currentPage - 1) * itemsPerPage;
    const currentItems = monthlyUsageList.slice(startIdx, startIdx + itemsPerPage);
  return (
      ...
      <Table className="min-w-full">
        <TableHeader>
          <TableRow>
            ...
            <TableHead>Time/Activ</TableHead>
