...
import { adminList } from "@/db/static-list";
...
export const AdminsTable = () => {
 const itemsPerPage = 10;
    ...
    const currentItems = adminList.slice(startIdx, startIdx + itemsPerPage);
  return (
    <div className="bg-white w-full rounded-[4px] p-3">
      ...
      <Table className="min-w-full">
        <TableHeader>
         <TableRow>
  <TableHead>#</TableHead>
  <TableHead>Month</TableHead>           {/* compName = oy nomi */}
  <TableHead>Usage Time</TableHead>      {/* compSize = foydalanilgan soat */}
  <TableHead>Category</TableHead>        {/* industry = maqsad turi */}
  <TableHead>User Count</TableHead>      {/* locationComp = foydalanuvchi soni */}
  <TableHead>Trend</TableHead>           {/* statusComp = holat (o‘smoqda, barqaror...) */}
  <TableHead>Action</TableHead>          {/* actionStatus = ko‘rish tugmasi */}
</TableRow>
