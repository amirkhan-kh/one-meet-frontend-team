              ...
              <TableCell className={``}>
                ...
                ${
                  item.actionStatus === "Views"
                    ? "border-green-100 border-1 text-green-700"
                    : item.actionStatus === "Edit"
                    ? "border-blue-100 border-1 text-blue-700"
                    : item.actionStatus === "View"
                    ? "border-yellow-100 border-1 text-yellow-700"
                    : item.actionStatus === "Delete"
                    ? "border-red-100 border-1 text-red-700"
                    : "border-gray-100 border-1 text-gray-600"
                }
              `}
                >
                  {item.actionStatus}
