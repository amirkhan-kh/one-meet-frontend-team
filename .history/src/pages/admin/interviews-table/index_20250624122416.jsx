...
import './style.css'
import { interviewsList } from "@/db/static-list";
export const InterviewsTable = () => {
  const itemsPerPage = 10;
    const [currentPage, setCurrentPage] = useState(1);
  
    const totalPages = Math.ceil(interviewsList.length / itemsPerPage);
    const startIdx = (currentPage - 1) * itemsPerPage;
    const currentItems = interviewsList.slice(startIdx, startIdx + itemsPerPage);
  return (
