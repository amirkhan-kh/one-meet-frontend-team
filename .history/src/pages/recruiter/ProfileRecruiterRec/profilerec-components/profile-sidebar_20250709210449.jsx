    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-white border border-gray-200">
        <div className="flex flex-col">
          ...
          >
            <Camera className=" h-4 mr-2 inline-block" />
            Upload Photo
          </Button>

          <div className="text-center">
            <p className="font-medium text-gray-900 flex items-center gap-1.5 text-center"> 
				<span>{data?.firstName || "Not provided"}</span>
