...
useEffect(() => {
  ...
  return (
    <div className="shadow-md rounded-md mb-10 bg-white translate-y-5">
      <p className="text-[19px] font-bold text-white border-l-[4px] border-[#2b43d4] p-4 rounded-tl-md bg-[#f4f5fd]">
        Payment History
      </p>
      <div className="">
        <Table>
          <TableHeader className=" text-white hover:bg-transparent focus:ring-0 border-l-[4px] border-[#2b43d4] bg-[#f4f5fd]">
