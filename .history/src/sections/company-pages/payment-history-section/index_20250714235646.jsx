          ...
          <TableBody>
            {data?.content?.map((item, index) => (
              <TableRow key={item.id || index}>
                ...
                <TableCell className={`transl`}>{item.plan?.amount || "-"}</TableCell>
                <TableCell className={`transl`}>{item.plan?.credits || "-"}</TableCell>
                <TableCell className={`transl`}>{item.plan?.currency || "-"}</TableCell>
                <TableCell>
                  {item.createdAt ? (
                    <>
                      <span>
