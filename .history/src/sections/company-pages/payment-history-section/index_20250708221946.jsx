...
const PaymentHistory = () => {
  ...
  if (loading) return <div className="shadow-md rounded-md px-3 sm:px-6 py-4 sm:p-6 mb-10 bg-white ">
  ...
  if (error) return <div className="px-3 sm:px-6 py-4 sm:p-6 mb-10 bg-white w-full">
     <Lottie
  ...
  return (
    <div className="shadow-md rounded-md px-3 sm:px-6 py-4 sm:p-6 mb-10 bg-white translate-y-10">
      <div className="">
