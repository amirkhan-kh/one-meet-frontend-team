          ...
          <TableBody>
            {data?.content?.map((item, index) => (
              <TableRow key={item.id || index}>
                ...
                <TableCell className={`transla`}>{item.plan?.amount || "-"}</TableCell>
                <TableCell className={`transla`}>{item.plan?.credits || "-"}</TableCell>
                <TableCell className={`transla`}>{item.plan?.currency || "-"}</TableCell>
                <TableCell>
                  {item.createdAt ? (
                    <>
                      <span>
