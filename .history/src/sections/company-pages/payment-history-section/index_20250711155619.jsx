...
useEffect(() => {
  ...
  return (
    <div className="shadow-md rounded-md mb-10 bg-white translate-y-5 border-[#2b43d4] border-l-[4px]">
      <div className="bg-[#f4f5fd] w-full ps-3">
      ...
      <div className="">
        <Table>
          <TableHeader className=" text-black hover:bg-transparent focus:ring-0 bg-[#f4f5fd]">
            <TableRow className="bg- hover:bg-bg-[#f4f5fd]  focus:ring-0 focus:outline-none border-none shadow-none p-4">
