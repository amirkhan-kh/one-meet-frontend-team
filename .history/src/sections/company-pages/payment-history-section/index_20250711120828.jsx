...
useEffect(() => {
  ...
  return (
    <div className="shadow-md rounded-md mb-10 bg-white translate-y-5 border-[#2b43d4]">
      <p className="text-[19px] font-bold text-black border-l-[4px] border-[#2b43d4] p-4 rounded-tl-md bg-[#f4f5fd]">
        Payment History
      </p>
      <div className="border-[#2b43d4]">
        <Table>
          <TableHeader className=" text-black hover:bg-transparent focus:ring-0 border-l-[4px]  bg-[#f4f5fd]">
