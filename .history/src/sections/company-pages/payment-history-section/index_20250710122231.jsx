...
const PaymentHistory = () => {
  ...
  return (
    <div className="shadow-md rounded-md mb-10 bg-white translate-y-5">
      <div className="">
        <p className=" text-[17px] font-medium text-white animated-gradient-card p-3 rounded-tl-md rounded-tr-md">Payment History</p>
      </div>
      <div className="">
        <Table>
          ...
          <TableBody>
            {currentItems.map((item) => (
              <TableRow key={item.id}>
                ...
                <TableCell>
                  {item?.createdAt ? (
                    <>
                      ...
                      <span className="animated-gradient-card text-white px-2 py-1 rounded mx-3">
                ...
                <TableCell
                  className={`ps-10 font-medium animated-gradient-card ${
