...
useEffect(() => {
  ...
  return (
    <div className="shadow-md rounded-md mb-10 ps-3 bg-white translate-y-5 border-[#2b43d4] border-l-[4px]">
      <p className="text-[19px] font-bold text-black  rounded-tl-md bg-[#f4f5fd]">
        Payment History
      </p>
      <div className="">
        <Table>
