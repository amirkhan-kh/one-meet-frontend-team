          ...
          <TableBody>
            {data?.content?.map((item, index) => (
              <TableRow key={item.id || index}>
                ...
                <TableCell className={`translate-`}>{item.plan?.amount || "-"}</TableCell>
                <TableCell className={`translate-`}>{item.plan?.credits || "-"}</TableCell>
                <TableCell className={`translate-`}>{item.plan?.currency || "-"}</TableCell>
                <TableCell>
                  {item.createdAt ? (
                    <>
                      <span>
