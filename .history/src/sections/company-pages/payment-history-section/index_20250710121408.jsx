...
const PaymentHistory = () => {
  ...
  return (
    <div className="shadow-md rounded-md mb-10 bg-white translate-y-5">
      <div className="">
        <p className=" text-[17px] font-medium text-white animated-gradient-card">Payment History</p>
      </div>
      <div className="">
        <Table>
          <TableHeader className={`animated-gradient-card text-white`}>
            <TableRow>
              <TableHead className={`text`}>Name</TableHead>
              <TableHead className={`text`}>Amount</TableHead>
              <TableHead className={`text`}>Credits</TableHead>
              <TableHead className={`ps-10.5`}>Created At</TableHead>
              <TableHead className={`text`}>Payment Status</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
