  ...
  return (
    <div className="shadow-md bg-white rounded-md px-3 sm:px-6 py-4 sm:p-6 mb-10">
      ...
      <div className="flex flex-col md:flex-row items-center gap-3">
       ...
       <div className="shadow-md hover:shadow-2xl sc p-4 bg-white rounded-sm w-full md:w-[40%] hover:bg-gradient-to-r hover:from-[#3b45d6] hover:to-[#611bd6] transition-colors duration-800 ease-in-out hover:text-white">
