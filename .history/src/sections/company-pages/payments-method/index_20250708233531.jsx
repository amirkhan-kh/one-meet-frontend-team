    ...
    return (
      <div className="shadow-md rounded-md px-3 sm:px-6 py-4 sm:p-6 mb-10 bg-white  translate-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            <Skeleton className="animated-gradient-card text-white rounded-md shadow-md p-4 min-h-[170px] cursor-pointer transition-transform duration-300 hover:scale-[1.004]" />
  ...
  return (
    <>
      ...
      <div className="w-full py-5">
        <div className=" max-h-[620px] overflow-scroll">
