          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-5 gap-x-2.5">
            {dataPlan.map((item) => (
              <div
                ...
                className="animated-gradient-card text-white rounded-md shadow-md p-4 min-h-[170px] cursor-pointer transition-transform duration-300 hover:scale-[1.006]"
              >
                <p className="font-semibold mb-4 flex justify-between border-b border-white pb-1 text-[22px]">
                  <span>{item?.name}</span>
                </p>
