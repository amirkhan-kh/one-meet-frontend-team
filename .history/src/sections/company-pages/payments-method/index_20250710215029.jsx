  ...
  return (
    <>
      ...
      <div className="w-full py-5">
        <div className="">
          <div className="gap-x-3.5 w-full overflow-x-auto flex bg-amber-300 min-h-[500px]">
            {dataPlan.map((item) => (
              <div
                key={item.id}
                onClick={() => handlePayment(item.id)}
                className="bg-[#f4f5fd] text-black min-w-[300px] rounded-md shadow-md p-4 min-h-[170px] cursor-pointer transition-transform duration-300 hover:scale-[1.004]"
              >
