      ...
      <div className="w-full gap-5">
        <div className="my-6">
          ...
          <div className="flex flex-col sm:flex-row items-center w-full justify-between gap-4">
            <div className="shadow p-3 rounded-sm w-full sm:w-[50%] hover:bg-[rgb(250,250,250)] transition-colors duration-800 ease-in-out">
            ...
            <div className="shadow p-3 rounded-sm w-full sm:w-[50%] hover:bg-[rgb(250,250,250)]">
