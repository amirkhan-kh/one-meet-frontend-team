           ...
           >
            {dataPlan.map((item) => (
              <div
                ...
                className="bg-[#f4f5fd] text-black w-[300px]  sm:w-[400px] min-w-[300px] sm:min-w-[400px] rounded-md shadow-md p-4 cursor-pointer transition-transform duration-300 hover:scale-[1.01] border-l-[4px] border-[#2b43d4]"
              >
                <p className="font-semibold mb-4 flex items-center justify-between border-b border-gray-300 pb-2 text-[22px]">
                  ...
                  <span className="text-[12px] bg-[rgba(0,0,0,0.1)] hover:bg-[rgba(53,52,52,0.1)] py-1.5 px-3 rounded-2xl">
                    Choose plan
                  </span>
                </p>
