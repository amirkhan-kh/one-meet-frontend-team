...
import { createPayment } from "@/store/company-service/payment-servce/payment-create-id";
...
const ownerUserId = useSelector((state) => state.companyProfileGet?.data?.id);
  ...
  const companyId = ownerUserId?.id; // bu /user/me dan olingan ID (ya'ni ownerUserId)
