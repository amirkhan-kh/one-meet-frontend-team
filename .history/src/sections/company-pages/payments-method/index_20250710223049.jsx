           ...
           >
            {dataPlan.map((item) => (
              <div
                ...
                className="bg-[#f4f5fd] text-black w-[400px] min-w-[400px] rounded-md shadow-md p-4 cursor-pointer transition-transform duration-300 hover:scale-[1.01] border-l"
              >
