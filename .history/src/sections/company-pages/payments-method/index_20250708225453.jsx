          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-5 gap-x-2.5">
            {dataPlan.map((item) => (
              <div
                ...
                className="bg-white rounded-sm shadow-sm p-2 min-h-[170px] cursor-pointer"
              >
                <p className="font-semibold mb-4.5 flex justify-between border-b-1 border-blue-700 text-[22px]">
                  <span>{item?.name}</span>
                </p>
                <div >
                ...
                <div className="flex  gap-1 justify-between">
                  ...
                  <p className="font-medium  inline-block px-2 rounded-[4px] text-gray-600">
                    $ {item?.amount}
                  </p>
                </div>
                <div className="flex  gap-1 justify-between">
                ...
                <p
                  className={`${
                    item?.active === "false" ? "bg-green-500 text-white py-1 px-2.5 rounded-sm" : "bg-red-600 py-1 px-2.5 rounded-sm text-white"
                  }`}
                >
