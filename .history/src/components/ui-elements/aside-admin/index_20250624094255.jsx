...
className="underline-hover flex items-center gap-2 py-2 px-2.5 rounded-[4px] hover:bg-[#f6f7f9] hover:scale-[1.01] hover:shadow-sm transition-all duration-200 ease-in-out">
