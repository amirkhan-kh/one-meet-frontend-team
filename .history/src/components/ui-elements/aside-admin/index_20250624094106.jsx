...
className="underline-hover flex items-center gap-2 py-2 px-2.5 rounded-[4px] hover:bg-[#1f32ad24] hover:scale-[1.02] hover:shadow-md transition-all duration-200 ease-in-out">
