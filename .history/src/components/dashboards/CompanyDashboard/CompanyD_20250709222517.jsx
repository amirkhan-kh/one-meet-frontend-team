...
export const CompanyDashboard = () => {
	return (
		 <>
      <CompanyHeader />
      <main className='min-h-screen pt-20 bg-[#f6f7f9] relative overflow-hidden'>
        ...
        <div className="htmlmain absolute top-0 left-0 w-full h-full z-[6] pointer-events-none">
