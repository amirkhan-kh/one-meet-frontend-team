...
export const DashboardFooter = () => {
  ...
  return (
    <footer className="px-2 md:px-6 py-8">
      <div className="flex flex-col  md:flex-row items-center justify-between w-full gap-6 md:gap-3">
        <div className=" px-3 sm:pr-4">
        ...
        <div className="flex   justify-between sm:justify-evenly w-full px-2 sm:px-4 ">
